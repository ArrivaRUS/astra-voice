...
## M6. Каталог `[~]` — v0.2 (состояние 23.09: блоки 1–5 + Р5 + Ц6 в main; открыты: полный загрузчик (очередь/пауза), US-11.3 OOM, состояние 20, Popup «Как мы считаем», карточка 20 состояний + снимки, CLI validate/benchmark)
