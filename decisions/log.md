...
- У10 пилюля — по центру снизу монитора активного окна, 48 px от края (сверху — симметрично);
  без активного окна — основной монитор. У11 онбординг пропускаемый по экранам, но завершение требует
