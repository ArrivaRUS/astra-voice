...
def pill_screen(theme):
    ...
    rubber = ('<div class="stc"><div class="stn">резиновая ширина<span class="code">решение G2</span></div>'
              ...
              '<div class="c12" style="margin-top:6px">Ширина считается по тексту: '
              '<b>обрезки многоточием быть не должно</b>. Русские подписи длиннее английских, поэтому '
              'фиксированные 172 px Handy не годятся. Высота всегда 36 px, радиус 18 px. '
              'Текст длиннее 320 px не бывает: самая длинная подпись — «Достигнут лимит записи».</div></div>')
    ...
    leg = ("<b>Пилюля-оверлей</b> (PRD F3): отдельное окно поверх всех, <b>не забирает фокус</b>, "
           ...
           "<b>«Готово» держится 500 мс</b> (решение 2026-09-08; в PRD F3.2 было 300 мс — правка). "
           "Ширина резиновая: 172 → 320 px, без многоточия.")
