...
5. ✅ **Цифры каталога** — закрыто 2026-09-08: все 12 позиций взяты из
   ...
   - **Оговорка в подсказке:** WER бенчмарка измерен на **fp32-весах** (публичных int8-замеров
     нет ни у одной модели).
   - **«Бенчмарк fp32»** на полоске скорости: T-one (int8-весов не существует), GigaAM Multilingual
     CTC 220M и GigaAM Multilingual Large CTC (int8-замера нет).
